...
exports.ExposeStore = (moduleRaidStr) => {
    ...
    window.Store.QueryExist = window.mR.findModule('queryExists') && window.mR.findModule('queryExists').length > 0 ?  window.mR.findModule('queryExists')[0].queryExists : window.mR.findModule('queryWidExists')[0].queryWidExists;
...
exports.LoadUtils = () => {
    ...
    window.isWWebJSInitialized = true;
};
